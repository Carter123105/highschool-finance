                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="system_name" class="form-control form-control-lg"
                                       value="<?php echo e(old('system_name', $setting->system_name ?? '')); ?>">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Email</label>
                                <input type="email" name="school_email" class="form-control"
                                       value="<?php echo e(old('school_email', $setting->school_email ?? '')); ?>">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Phone</label>
                                <input type="text" name="school_phone" class="form-control"
                                       value="<?php echo e(old('school_phone', $setting->school_phone ?? '')); ?>">
                            </div>

                            <div class="col-12">
                                <label class="form-label">Address</label>
                                <textarea name="school_address" class="form-control" rows="3"><?php echo e(old('school_address', $setting->school_address ?? '')); ?></textarea>
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="currency" id="currencySelect" class="form-select form-select-lg">
                                    <option value="LRD" <?php echo e(($setting->currency ?? '') == 'LRD' ? 'selected' : ''); ?>>LRD - Liberian Dollar</option>
                                    <option value="USD" <?php echo e(($setting->currency ?? '') == 'USD' ? 'selected' : ''); ?>>USD - US Dollar</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6" id="exchangeRateBox" style="display:none;">
                                ...
                                <input type="number" step="0.01" name="exchange_rate" class="form-control form-control-lg"
                                       value="<?php echo e(old('exchange_rate', $setting->exchange_rate ?? '')); ?>">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Receipt Prefix</label>
                                <input type="text" name="receipt_prefix" class="form-control"
                                       value="<?php echo e(old('receipt_prefix', $setting->receipt_prefix ?? 'REC')); ?>">
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\highschool-finance\resources\views/settings/index.blade.php ENDPATH**/ ?>