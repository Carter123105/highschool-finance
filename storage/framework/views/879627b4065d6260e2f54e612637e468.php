...
<div class="container-fluid invoice-page">
    ...
    <div class="page-header d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(route('invoices.create')); ?>" class="btn btn-light">
            ...
            <table class="table align-middle mb-0">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo e($invoice->student->first_name ?? ''); ?>
                        ...
                        <td><?php echo e(number_format($invoice->paid_amount ?? 0, 2)); ?></td>
                        <td><?php echo e(number_format($invoice->balance ?? 0, 2)); ?></td>
