        ...
        <div class="receipt">
            ...
            <?php if($logoUrl): ?>
                ...
                <div class="watermark">
                    ...
                    <img src="<?php echo e($logoUrl); ?>" alt="School Logo" onerror="this.style.display='none'">
            ...
            <div class="receipt-header">
                ...
                <div class="logo-box">
                    ...
                    <?php if($logoUrl): ?>
                        ...
                        <img src="<?php echo e($logoUrl); ?>"
                             alt="<?php echo e($setting->school_name ?? 'School Logo'); ?>"
                             class="school-logo"
                             onerror="this.src='<?php echo e($defaultLogo); ?>'; this.onerror=null;">
                ...
                <div class="school-info">
                    ...
                    <h2 class="school-name">
                        ...
                        <?php echo e($setting->school_name ?? 'SCHOOL NAME'); ?>
                    ...
                    <p class="system-name">
                        ...
                        <?php echo e($setting->system_name ?? 'Finance System'); ?>
                    ...
                    <p>
                        ...
                        <?php echo e($setting->school_address ?? 'Address'); ?>
                    ...
                    <p>
                        ...
                        Tel: <?php echo e($setting->school_phone ?? 'N/A'); ?>
            ...
            <div class="details">
                ...
                <div class="detail-row">
                    ...
                    <div>
                        ...
                        <small class="
                            <?php if(strtolower($studentType) == 'new'): ?>
                                text-primary
                            <?php elseif(strtolower($studentType) == 'old'): ?>
                                text-success
                            <?php else: ?>
                                text-muted
                            <?php endif; ?>
                        ">
                            ...
                            (<?php echo e(ucfirst($studentType)); ?> Student)
                    ...
                    <div class="text-end">
                        ...
                        <span class="
                            <?php if($status == 'Fully Paid'): ?>
                                text-success
                            <?php elseif($status == 'Partially Paid'): ?>
                                text-warning
                            <?php else: ?>
                                text-danger
                            <?php endif; ?>
                ...
                <?php if($mobileMoneyRef): ?>
                    ...
                    <div class="detail-row momo-ref-row">
                        ...
                        <div>
                            ...
                            <span class="text-uppercase"><?php echo e(str_replace('_', ' ', $paymentMethod)); ?></span>
                        ...
                        <div class="text-end">
                            ...
                            <span class="momo-ref-code"><?php echo e($mobileMoneyRef); ?></span>

                        </div>

                    </div>

                <?php elseif($isMobileMoney): ?>
                ...
                <?php else: ?>
                    ...
                    <div class="detail-row">
                        ...
                        <div class="text-end">
                            ...
                            <?php echo e(optional($payment->receiver)->name ?? optional($payment->recordedBy)->name ?? 'System'); ?>
            ...
            <table class="table payment-table mt-1 mb-1">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $feeBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feeName => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr>
                        ...
                        <td class="text-end text-success">
                            ...
                            <?php echo e(number_format($toCurrency($paidRaw), 2)); ?>
                        ...
                        <td class="text-end text-danger">
                            ...
                            <?php echo e(number_format($toCurrency($feeBalanceRaw), 2)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\highschool-finance\resources\views/payments/receipt.blade.php ENDPATH**/ ?>