        ...
        <div class="col-lg-8 animate-in delay-2">
            <div class="modern-card">
                <div class="modern-card-header">
                    ...
                    <span class="badge-count"><?php echo e(count($recentInvoices)); ?> records</span>
                </div>
                ...
                <div class="table-responsive">
                        ...
                        <table class="modern-table">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $recentInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="invoice-id">#<?php echo e($invoice->invoice_no ?? 'N/A'); ?></span>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            <span class="amount total">$<?php echo e(number_format($total, 2)); ?></span>
                                        </td>
                                        <td class="text-end">
                                            <span class="amount paid">$<?php echo e(number_format($paid, 2)); ?></span>
                                        </td>
                                        <td class="text-end">
                                            <span class="amount balance">$<?php echo e(number_format(max($balance, 0), 2)); ?></span>
                                        </td>
                                        <td>
                    ...
                    <?php else: ?>
                        <div class="empty-state">
                            ...
                            <p>No recent invoices found for <?php echo e($selectedYearName); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="modern-card">
                ...
                <div class="payment-list">
                            ...
                            <div class="payment-item">
                                <div class="payment-left">
                                    ...
                                    <div class="payment-details">
                                        <div class="payment-id"><?php echo e($payment->receipt_no ?? 'N/A'); ?></div>
                                        <div class="payment-time">
                                            <i class="far fa-clock" style="font-size: 0.625rem; margin-right: 0.25rem;"></i>
                                            <?php echo e(optional($payment->created_at)->diffForHumans() ?? 'N/A'); ?>

                                        </div>
                                    </div>
                                </div>
                                <div class="payment-amount">
                                    +$<?php echo e(number_format(floatval($payment->amount_paid ?? 0), 2)); ?>
                    ...
                    <?php else: ?>
                        <div class="empty-state">
                            <i class="fas fa-credit-card"></i>
                            <p>No recent payments found for <?php echo e($selectedYearName); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
                
                <?php if(count($recentPayments) > 0): ?>
                    <a href="<?php echo e(route('payments.index')); ?>" class="view-all">
