...
<div class="dashboard-container">
    ...
    <div class="top-bar">
        ...
        <a href="<?php echo e(route('invoices.index')); ?>" class="btn-back">
                    ...
                    <div class="card-body-modern">
                        ...
                        <div class="form-group">
                            ...
                            <div class="select-wrapper">
                                <select name="student_type" id="studentType" class="form-select-modern" required>
                                    ...
                                    <option value="Old" <?php echo e(old('student_type') == 'Old' ? 'selected' : ''); ?>>Old Students</option>
                                    <option value="New" <?php echo e(old('student_type') == 'New' ? 'selected' : ''); ?>>New Students</option>
                                </select>
                                <i class="fas fa-chevron-down select-arrow"></i>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="select-wrapper">
                                <select name="section_id" id="sectionSelect" class="form-select-modern">
                                    ...
                                    <option value="9" <?php echo e(old('section_id') == '9' ? 'selected' : ''); ?>>Section A</option>
                                    <option value="1" <?php echo e(old('section_id') == '1' ? 'selected' : ''); ?>>Section B</option>
                                </select>
                                <i class="fas fa-chevron-down select-arrow"></i>
                            </div>
                        </div>
                                ...
                                <select name="academic_year_id" class="form-select-modern" required>
                                    ...
                                    <?php $__currentLoopData = $academicYears ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($year->id); ?>" <?php echo e(old('academic_year_id') == $year->id ? 'selected' : ''); ?>>
                                            <?php echo e($year->name ?? $year->title ?? 'Academic Year'); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="date" name="due_date" class="form-input-modern" value="<?php echo e(old('due_date')); ?>">
...
<script>
const studentsData = <?php echo json_encode($students ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\highschool-finance\resources\views/invoices/create.blade.php ENDPATH**/ ?>