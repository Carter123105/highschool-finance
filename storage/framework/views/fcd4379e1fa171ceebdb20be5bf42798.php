    ...
    <div class="invoice-page">
        <div class="access-wrap">
            <div class="access-card">
                ...
                <a href="<?php echo e(route('invoices.index')); ?>" class="back-btn">Return</a>
            </div>
        </div>
    </div>
...
<div class="invoice-page">
    ...
    <div class="page-header">
        ...
        <a href="<?php echo e(route('invoices.index')); ?>" class="back-btn">← Back</a>
    </div>
            ...
            <div class="card-ui">
                ...
                <div class="form-section">
                    ...
                    <select name="section_name" id="sectionSelect">
                        ...
                        <?php $__currentLoopData = $sections->pluck('name')->unique(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
