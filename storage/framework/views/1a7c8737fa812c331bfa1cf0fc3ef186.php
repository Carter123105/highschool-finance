...
<div class="container-fluid py-3 payments-dashboard">
    ...
    <div class="page-header">
        ...
        <a href="<?php echo e(route('payments.create')); ?>" class="btn-add-payment">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card green">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value">LRD <?php echo e(number_format($totalPaidAll, 2)); ?></div>
            </div>
            <span class="stat-trend trend-up">
        ...
        <div class="stat-card orange">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value">LRD <?php echo e(number_format($totalBalance, 2)); ?></div>
            </div>
    ...
    <div class="summary-bar">
        <div class="summary-item">
            ...
            <strong class="expected">LRD <?php echo e(number_format($totalExpected, 2)); ?></strong>
        </div>
        <div class="summary-divider"></div>
        <div class="summary-item">
            <small>Total Collected</small>
            <strong class="paid">LRD <?php echo e(number_format($totalPaidAll, 2)); ?></strong>
        </div>
        <div class="summary-divider"></div>
        <div class="summary-item">
            <small>Outstanding</small>
            <strong class="balance">LRD <?php echo e(number_format($totalBalance, 2)); ?></strong>
        </div>
        <div class="summary-divider"></div>
        <div class="summary-item">
            <small>Fully Paid</small>
            <strong style="color:var(--success);"><?php echo e($fullyPaidCount); ?></strong>
        </div>
        <div class="summary-divider"></div>
        <div class="summary-item">
            <small>Partially Paid</small>
            <strong style="color:var(--warning);"><?php echo e($partialCount); ?></strong>
        </div>
        <div class="summary-divider"></div>
        <div class="summary-item">
            <small>Not Paid</small>
            <strong style="color:var(--danger);"><?php echo e($notPaidCount); ?></strong>
        </div>
    </div>
    ...
    <div class="main-card">
        ...
        <div class="card-header-custom">
            <div class="d-flex align-items-center gap-2 flex-wrap">
                ...
                <span class="header-badge"><?php echo e($groupedPayments->count()); ?> Students</span>
            </div>
        ...
        <div class="payments-list" id="paymentsList">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $groupedPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studentId => $studentPayments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="payment-record-card" data-student-name="<?php echo e(strtolower($studentName)); ?>">

                    
                    <div class="record-top">
                        <div class="student-section">
                            <div class="student-avatar"><?php echo e($initials ?: 'ST'); ?></div>
                            <div>
                                <h6 class="student-name"><?php echo e($studentName ?: 'Unknown Student'); ?></h6>
                                <div class="student-meta">
                                    <?php echo e($student->student_id ?? 'ID: N/A'); ?> &bull; <?php echo e($studentPayments->count()); ?> payment record(s)
                                </div>
                            </div>
                        </div>
                        <div class="status-pill status-<?php echo e($statusClass); ?>">
                    ...
                    <div class="record-body">
                        <div class="record-stats">
                            <div class="mini-stat">
                                ...
                                <h5 class="amount-invoice">LRD <?php echo e(number_format($totalInvoice, 2)); ?></h5>
                            </div>
                            <div class="mini-stat">
                                <small>Amount Paid</small>
                                <h5 class="amount-paid">LRD <?php echo e(number_format($totalPaid, 2)); ?></h5>
                            </div>
                            <div class="mini-stat">
                                <small>Balance</small>
                                <h5 class="amount-balance">LRD <?php echo e(number_format($balance, 2)); ?></h5>
                            </div>
                            <div class="mini-stat">
                                <small>Progress</small>
                                <div class="progress-bar-bg">
                                    <div class="progress-bar-fill <?php echo e($progressClass); ?>" style="width:<?php echo e($progressPercent); ?>%"></div>
                                </div>
                                <div class="progress-text"><?php echo e(number_format($progressPercent, 1)); ?>% completed</div>
                            </div>
                        </div>

                        
                        <div class="view-details-wrap">
                            <button class="btn-toggle" onclick="toggleDetails('details-<?php echo e($studentId); ?>')">
                                <i class="bi bi-chevron-down"></i> View Details
                            </button>
                        </div>

                        
                        <div class="payment-details" id="details-<?php echo e($studentId); ?>">
                            <div class="details-grid">
                                ...
                                <div>
                                    ...
                                    <div class="record-section">
                                        ...
                                        <div class="fees-grid">
                                            <?php $__empty_2 = true; $__currentLoopData = $feeBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feeName => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                <div class="fee-item">
                                                    <span><?php echo e($feeName); ?></span>
                                                    <strong>LRD <?php echo e(number_format($amount, 2)); ?></strong>
                                                </div>
                                    ...
                                    <div class="record-section">
                                        ...
                                        <div class="fees-grid">
                                            <?php $__currentLoopData = $studentPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="fee-item">
                                                    <span>
                                                        ...
                                                        <?php if($payment->payment_method): ?>
                                                            <span class="text-muted" style="font-size:0.7rem;">(<?php echo e($payment->payment_method); ?>)</span>
                                                        <?php endif; ?>
                                                    </span>
                                                    <strong>LRD <?php echo e(number_format($payment->amount_paid ?? 0, 2)); ?></strong>
                                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="record-section">
                                        ...
                                        <div class="user-tags">
                                            <?php $__empty_2 = true; $__currentLoopData = $receivedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                <span class="user-tag"><?php echo e($userName); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                    ...
                                    <div class="record-section">
                                        ...
                                        <div class="record-actions">
                                            <?php if($student): ?>
                                                <a href="<?php echo e(route('students.show', $student->id)); ?>" class="btn-action btn-view">
                                                    <i class="bi bi-person"></i> Profile
                                                </a>
                                            <?php endif; ?>
                                            <?php if($invoices->isNotEmpty()): ?>
                                                <a href="<?php echo e(route('invoices.show', $invoices->first()->id)); ?>" class="btn-action btn-view">
                                                    <i class="bi bi-receipt"></i> Invoice
                                                </a>
                                            <?php endif; ?>
                                            
                                            <?php $__currentLoopData = $studentPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e(route('payments.receipt', $payment->id)); ?>" class="btn-action btn-view">
                                                    <i class="bi bi-file-earmark-text"></i> Receipt <?php echo e($payment->receipt_no); ?>

                                                </a>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(route('payments.create', ['student_id' => $studentId])); ?>" class="btn-action btn-edit">
                                                <i class="bi bi-plus-lg"></i> Add Payment
                                            </a>
                                        </div>
                                    </div>
        ...
        <?php if(method_exists($payments, 'links') && $payments->hasPages()): ?>
            <div class="pagination-container">
                <div class="pagination-wrapper">
                    <div class="pagination-info-text">
                        Showing <strong><?php echo e($payments->firstItem()); ?></strong> to <strong><?php echo e($payments->lastItem()); ?></strong> of <strong><?php echo e($payments->total()); ?></strong> records
                    </div>
                    ...
                    <div class="pagination-controls">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($payments->previousPageUrl()); ?>" class="pagination-btn nav-btn">
                                <i class="bi bi-chevron-left"></i> Prev
                            </a>
                        <?php endif; ?>
                        ...
                        <?php $__currentLoopData = $payments->getUrlRange(1, $payments->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page == $payments->currentPage()): ?>
                        ...
                        <?php if($payments->hasMorePages()): ?>
                            <a href="<?php echo e($payments->nextPageUrl()); ?>" class="pagination-btn nav-btn">
                    ...
                    <div class="d-flex align-items-center gap-3 flex-wrap">
                        <div class="items-per-page">
                            ...
                            <select onchange="window.location.href=this.value">
                                <?php $__currentLoopData = [10, 25, 50, 100]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perPage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(request()->fullUrlWithQuery(['per_page' => $perPage])); ?>" <?php echo e(request('per_page', 10) == $perPage ? 'selected' : ''); ?>>
                                        <?php echo e($perPage); ?>
                        ...
                        <div class="go-to-page">
                            <label>Go to:</label>
                            <input type="number" id="goToPage" min="1" max="<?php echo e($payments->lastPage()); ?>" placeholder="#">
