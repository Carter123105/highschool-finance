        ...
        <div class="card-header-custom">
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap">
                ...
                <span class="header-badge">
                    {{ $groupedPayments->count() }} Students
                </span>
                        ...
                        <div class="student-section">
                            ...
                            <div>
                                ...
                                <div class="student-meta">
                                    {{ $studentPayments->count() }} payment(s)
                                </div>
                    ...
                    <div class="record-body">
                        ...
                        <div class="view-details-wrap">
                            ...
                            <button class="btn-toggle"
                                    onclick="toggleDetails('details-{{ $studentId }}')">
                                    ...
                                    @if($latestPayment)
                                        ...
                                        <div class="record-section">
                                            ...
                                            <div class="record-actions">
                                                ...
                                                <a href="{{ route('payments.receipt', $latestPayment->id) }}"
                                                ...
                                                <form action="{{ route('payments.destroy', $latestPayment->id) }}"
                                                      method="POST">
