        ...
        <div class="table-responsive-wrap">
            <table class="table-modern" id="usersTable">
                ...
                @forelse($users as $user)
                    ...
                    <tr data-user-name="{{ strtolower($user->name) }}" data-user-email="{{ strtolower($user->email) }}">
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <a href="{{ route('admin.users.create') }}" class="btn-create-user" style="margin-top: 1rem;">
                                    <i class="bi bi-person-plus-fill"></i>
                                    Create First User
                                </a>
                            </div>
