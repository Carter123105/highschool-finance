    ...
    <div class="dashboard-header mb-4">
        ...
        <div class="header-actions">
            ...
            <button type="button" class="btn-daily" onclick="openDailyModal()">
                ...
                Daily Transactions
                @if($todayCount > 0)
                    <span class="badge bg-dark">{{ $todayCount }}</span>
                @endif
            </button>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card warning">
                ...
                <div class="stat-info">
                    ...
                    <h3 class="{{ $outstandingFees > 0 ? 'text-warning' : 'text-success' }}">
        ...
        <div class="alert alert-info daily-alert mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    {{ $todayCount }} transaction(s) recorded today totaling
                    <strong>${{ number_format($totalTodayTransactions, 2) }}</strong>
                </div>
            </div>
        </div>
    @endif
                                ...
                                <div class="summary-card">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <small class="text-muted" id="countPayments">{{ $todayPayments->count() }} payment(s)</small>
                                        </div>
                                ...
                                <div class="summary-card">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <small class="text-muted" id="countExpenses">{{ $todayExpenses->count() }} expense(s)</small>
                                        </div>
                                ...
                                <div class="summary-card">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <small class="text-muted" id="countTotal">{{ $todayCount }} total transaction(s)</small>
                                        </div>
                        ...
                        <div class="tab-pane fade show active" id="paymentsPane" role="tabpanel">
                            <div class="table-responsive" id="paymentsTableContainer">
                                <table class="table table-hover align-middle">
                                    ...
                                    <tfoot id="paymentsTableFoot" class="table-group-divider {{ $todayPayments->count() == 0 ? 'd-none' : '' }}">
                                        <tr class="table-light fw-bold">
                                            <td colspan="3">Total Payments</td>
                                            <td class="text-success" id="footPayTotal">${{ number_format($totalTodayPayments, 2) }}</td>
                                            <td colspan="3"></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table class="table table-hover align-middle">
                                    ...
                                    <tbody id="expensesTableBody">
                                        @forelse($todayExpenses as $index => $expense)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td><strong>{{ $expense->title ?? 'N/A' }}</strong></td>
                                                <td>
                                                    <span class="badge bg-{{ $expense->category ? 'info' : 'warning text-dark' }}">
                                                        {{ $expense->category ?? 'Uncategorized' }}
                                                    </span>
                                                </td>
                                                <td class="fw-bold text-danger">${{ number_format($expense->amount, 2) }}</td>
                                                <td><small class="text-muted">{{ Str::limit($expense->description, 50) }}</small></td>
                                    ...
                                    <tfoot id="expensesTableFoot" class="table-group-divider {{ $todayExpenses->count() == 0 ? 'd-none' : '' }}">
                                        <tr class="table-light fw-bold">
                                            <td colspan="3">Total Expenses</td>
                                            <td class="text-danger" id="footExpTotal">${{ number_format($totalTodayExpenses, 2) }}</td>
                                            <td colspan="3"></td>
                                        </tr>
                                    </tfoot>
                                </table>
