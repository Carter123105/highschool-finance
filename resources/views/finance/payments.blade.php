...
{{-- ================= PRINT FIX (FINAL STABLE VERSION) ================= --}}
<style>
@media print {
...
<div class="payments-report container-fluid py-4">
    ...
    <div class="payments-header no-print mb-3">
        ...
        <div class="header-actions">
            ...
            <a href="{{ route('finance.summary') }}" class="btn-back">
                Back
            </a>
                ...
                <table class="table table-bordered align-middle mb-0">
                    ...
                    @forelse($payments as $payment)
                        ...
                        <tr>
                            ...
                            <td><span class="badge">{{ $payment->receipt_no }}</span></td>
                            ...
                            <td>
                                ...
                                <br>
                                <small>{{ $displayDate->format('h:i A') }}</small>
                            </td>
                            <td>Completed</td>
                        </tr>
